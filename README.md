...
Simple AI based on Python, written using numpy, skearn, and wordnet with manual training.
...
```
Create a comprehensive Q&A knowledge base for [TOPIC] in Russian. 
Format: strictly as Python dictionary with Russian questions as keys and detailed Russian answers as values.
...
**Example AI Prompt:**
```
Create a comprehensive Q&A knowledge base for Python programming in Russian. 
Format: strictly as Python dictionary with Russian questions as keys and detailed Russian answers as values.

Generate 30 question-answer pairs covering:
...
Provide the output as a complete Python dictionary that I can directly copy into my knowledge_base.
```
...
My Telegram: [https://t.me/inc0bio](https://t.me/inc0bio)
...
```
Создай комплексную базу знаний вопросов и ответов по [ТЕМА] на русском языке.
Формат: строго как словарь Python с русскими вопросами в качестве ключей и подробными русскими ответами в качестве значений.
...
```
Создай комплексную базу знаний вопросов и ответов по программированию на Python на русском языке.
Формат: строго как словарь Python с русскими вопросами в качестве ключей и подробными русскими ответами в качестве значений.

Сгенерируй 30 пар вопрос-ответ, охватывающих:
...
Предоставь результат в виде полного словаря Python, который я могу напрямую скопировать в knowledge_base.
```
...
Example format for the dictionary structure:
{
    ...
    "how work [process]": "[step-by-step description]",
...
Мой Telegram: [https://t.me/inc0bio](https://t.me/inc0bio)
